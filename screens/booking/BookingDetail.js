...
import RoomTypeInfo from "../../components/booking/RoomTypeInfo";
import TimeInfo from "../../components/booking/TimeInfo";
import GuestsInfo from "../../components/booking/GuestsInfo";
import NoteInfo from "../../components/booking/NoteInfo";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
        <BookingImage 
          imageUrl={rentalData.image && rentalData.image.length > 0 ? rentalData.image[0] : null} 
        />
