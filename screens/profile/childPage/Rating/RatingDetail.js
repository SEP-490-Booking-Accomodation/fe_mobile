...
export default function RatingDetail({ rating, onBack, formatDate, renderStars }) {
        ...
        <View style={styles.detailContainer}>
            ...
            <ScrollView style={styles.detailContent} showsVerticalScrollIndicator={false}>
                <View style={styles.accommodationCard}>
                    <Image
                        source={{
                            uri: rating.bookingId?.accommodationId?.image?.[0] || "/placeholder.svg?height=100&width=100",
                        }}
                ...
                {rating.contentReply && (
                    <View style={styles.replySection}>
                        ...
                        <View style={styles.replyBox}>
                            ...
                            <Text style={styles.replyDate}>{rating.updatedAt && formatDate(rating.updatedAt)}</Text>
                        </View>
                    </View>
                )}
